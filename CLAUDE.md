...
Her yeni Claude Code session'ında şunu söyle:

> **"memory'yi oku, projeyi tanı"**

Claude otomatik olarak `mcp__memory__read_graph` + file-based memory'yi yükler ve projeyi tanır.
